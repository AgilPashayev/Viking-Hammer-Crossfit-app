...
export const fetchMembershipPlans = async (): Promise<{
  plans: MembershipPlanDB[];
  error: string | null;
}> => {
  try {
...
export const createMembershipPlan = async (
  planData: MembershipPlanInput,
): Promise<{ plan: MembershipPlanDB | null; error: string | null }> => {
  try {
...
export const updateMembershipPlan = async (
  planId: number,
  planData: Partial<MembershipPlanInput>,
): Promise<{ plan: MembershipPlanDB | null; error: string | null }> => {
  try {
    const updates: any = {};
